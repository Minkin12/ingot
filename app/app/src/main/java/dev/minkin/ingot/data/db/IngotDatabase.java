...
@Database(version = 4, entities = {TrainingMaxEntity.class, ProgramTemplateEntity.class, PerformedSetEventEntity.class, WorkoutCompletedEventEntity.class, OutboxEntity.class},exportSchema = false)
