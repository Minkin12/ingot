...
@Database(version = 3, entities = {TrainingMaxEntity.class, ProgramTemplateEntity.class, PerformedSetEventEntity.class, WorkoutCompletedEventEntity.class},exportSchema = false)
